...
def ntest_get_database():
    ...
    d2 = notion.get_database('46cc62902cf14338bba154af1cc0a5a2')
    # print(d1)
    # print('queried')
    # assert False
...
def test_get_database():
    ...
    d3 = notion.get_database('f498a77f33294873a752e858dc4f9b8c')
    d3.test_types = ['check_box']

    d4 = notion.get_database('989cc0ed5d164c6bb7fe852e51fb8e19')
